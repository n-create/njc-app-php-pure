    ...
    <form id="bkSearch" method="get" action="/sale/result.php" class="saleSearch jyoken">
        <div class="searchIndex">
            ...
            <div class="searchBox">
                ...
                <div class="searchBoxInner rimawari">
                    <div class="row">
                        <div class="h5 col-lg-2 col-md-3 col-12"><?= $searchManager->getBkItemName($rentSaleStr, $searchManager::BK_DATA_SYUEKI); ?></div>
                        <div class="col-lg-10 col-md-9 col-12">
                            <div class="inner">
                                <ul class="main rimawari">
                                    <li class="sub sub_rimawari">
                                        <label class="form-control">
                                            <input type="checkbox" name="rimawari" value="1" class="child checksubmit rimawari"><span>収益物件</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="searchBoxInner rimawari_per">
                    <div class="row">
                        <div class="h5 col-lg-2 col-md-3 col-12"><?= $searchManager->getBkItemName($rentSaleStr, $searchManager::BK_DATA_SYUEKI_PER); ?></div>
                        <div class="col-lg-10 col-md-9 col-12">
                            <div class="inner">
                                <?php $master = $searchManager->getBkSearchMaster($rentSaleStr, $searchManager::BK_DATA_SYUEKI_PER); ?>
                                <select name="rimawari_per" class="rimawari_per form-control">
                                    <?php foreach($master['search'] as $value => $text) { ?>
                                    <option value="<?= $value; ?>"><?= $text; ?></option>
                                    <?php } ?>
                                </select>
